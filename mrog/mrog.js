let mrogs = [
  {
    time: "1662495458426",
    text: "<p>在对任何概念的理解过程中，比喻或许可以增加对概念的亲和性，从直观上理解概念。但是绝不可以替代真正的定义去对概念产生真正的领会。无论怎样，就算可能不理解\
           也应该第一步从定义出发熟记概念。当有人希望你解释一个概念时，脑海里第一想法应该是对应的概念，而不是妄图以比喻去阐述。"
  },
  {
    time: "1660872009665",
  ...
  },
  {
    ...
    text: "<p>一部作品是作者创作出来的世界，尽管可能和生活的现实世界有关联，但终究是不同的。因此在评价作品时产生了以下两个角度：</p>\
           <p>一是遵循作者的设定，然后根据这些设定去推断作者剧情的合理性。以这样的想法去分析作品时，当我们看到作者书写的某些情节可能在现实世界看来缺乏合理性，\
           但在作品中采取这样的行为未必是值得观看者批判的。</p>\
           <p>二是质疑作者的设定。不过这样以来需要谨记的是我们的评价后产生的作品已经不是作者的作品了，而是我们自己的作品。这在自己需要写类似的作品时是需要转变的一个观念，\
           但是作为普通观众持有这样的观点而对作品大加批判或许是欠考虑的。</p>"
  },
  {
    time: "1638544206790",
  ...
  {
    time:"1634222607895",
    text:"<p>当前新技术不断涌现，作为普通人只能不断去追逐这些。今日学四个，明日学五个，然后得一夕安寝，起视四方，而技术又至矣。有些人就会安慰自己：\
          “书山有路勤为径，学海无涯苦作舟”。但这是被环境推着走的思考方式，如果有可能的话，还是尽量找到自己的东西，并专精于此，以自己来引领环境。</p>"
  },
  {
    time:"1621055629135",
